...
import { GetOrdersInterface } from '@/api/get-orders'
...
export function OrderTableRow({ order }: OrderTableRowProps) {
  ...
  function updateOrderStatusOnCache(
    ...
    const cached = queryClient.getQueriesData<GetOrdersInterface>({
      queryKey: ['orders'],
    })
    ...
    cached.forEach(([cachedKey, cachedData]) => {
      ...
      queryClient.setQueryData<GetOrdersInterface>(cachedKey, {
        ...cachedData,
